...
const suppliersData = [
  { name: 'Mi Distributors', contact: ['Whatsapp: +1 (754) 236-9859'], whatsapp: '17542369859' },
  { name: 'Techland', contact: ['Whatsapp: +1 (786) 683-2702', 'Llamadas: +1 (305) 614-4478'], whatsapp: '17866832702' },
  { name: 'CORBAL', contact: ['Whatsapp: +1 (407) 289-6091'], whatsapp: '14072896091' },
  { name: 'Ena Wireless', contact: ['Whatsapp: +1 (786) 307-1638'], whatsapp: '17863071638' },
]
                    ...
                    <td className="py-4 px-6">
                      <div className="flex items-center justify-center">
                        <a
                          ...
                          aria-label={`Contactar a ${item.name} por WhatsApp`}
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24"
                            fill="currentColor"
                            className="w-5 h-5 text-neutral-400 hover:text-[#25D366] transition-colors"
                          >
