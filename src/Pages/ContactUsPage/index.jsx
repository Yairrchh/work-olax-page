    ...
    return (
        <Layout>
            <div className="div-contacto w-full h-3/4 flex flex-col gap-y-12 items-center justify-center rounded-2xl mx-3">
                <div>
                    <h1 className="text-white text-5xl sm:text-6xl md:text-7xl lg:text-9xl mt-12 lg:mt-20 font-extralight">Contáctanos</h1>
                </div>
                <div className="flex items-center justify-center">
                    <p className="text-white text-xl w-8/12 mt-10 mb-20 text-center font-light">Embrace Better Life. Innovando el mercado tecnológico. Productos 100% garantizados. Cuenta con OLAX en cualquier lugar y en todo momento.</p>
                </div>
            </div>
            ...
            <div className="div-contact-map flex flex-col lg:flex-row items-center justify-center gap-x-8 xl:gap-x-40 gap-y-8">
                <FormContact/>
                <div>
