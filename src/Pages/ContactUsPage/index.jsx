    ...
    return (
        <>
            ...
            <div className="flex flex-wrap items-center justify-center gap-x-16 gap-y-3 mt-6 md:mt-16">
                <div className="div-contain flex flex-col items-center justify-center gap-2 md:gap-3 w-full sm:w-72 h-auto py-4 md:h-40 md:py-0 rounded-2xl bg-red-700
                                transition-transform transform-gpu hover:scale-110 ease-out duration-300">
                    <figure className="flex items-center rounded-lg justify-center w-9 h-9 md:w-12 md:h-12 bg-red-700 hover:bg-gray-600">
                        <img className="w-6 h-6 md:w-8 md:h-8" src={iconllamada} alt="Icono de llamada" loading="lazy"/>
                    </figure>
                    <div>
                        <p className="text-white text-base md:text-2xl font-light"> +1(786) 8194377</p>
                    </div>
                </div>
                <div className="div-contain flex flex-col items-center justify-center gap-2 md:gap-3 w-full sm:w-72 h-auto py-4 md:h-40 md:py-0 rounded-2xl bg-red-700
                                transition-transform transform-gpu hover:scale-110 ease-out duration-300">
                    <a href="mailto:olaxsolutionsmp@gmail.com" target="_blank" rel="noopener noreferrer">
                        <figure className="flex items-center rounded-lg justify-center w-9 h-9 md:w-12 md:h-12 bg-red-700 hover:bg-gray-600">
                            <img className="w-6 h-6 md:w-8 md:h-8" src={iconEmail} alt="Icono de correo" loading="lazy"/>
                        </figure>
                    </a>
                    <div>
                        <p className="text-white text-base md:text-2xl font-light">info@olaxglobal.com</p>
                    </div>
                </div>
                <div className="div-contain flex flex-col items-center justify-center gap-2 md:gap-3 w-full sm:w-72 h-auto py-4 md:h-40 md:py-0 rounded-2xl bg-red-700
                                transition-transform transform-gpu hover:scale-110 ease-out duration-300">
                    <a href="https://www.google.com/maps/place/8422+NW+66th+St,+Miami,+FL+33166,+EE.+UU./@25.8332953,-80.3376824,17z/data=!3m1!4b1!4m6!3m5!1s0x88d9bbc6579f5f1b:0x5aed62e370179f3b!8m2!3d25.8332905!4d-80.3351075!16s%2Fg%2F11j0tb0pbm?hl=es&entry=ttu" target="_blank" rel="noopener noreferrer">
                        <figure className="flex items-center rounded-lg justify-center w-9 h-9 md:w-12 md:h-12 bg-red-700 hover:bg-gray-600">
                            <img className="w-6 h-6 md:w-8 md:h-8" src={iconMap} alt="Icono de mapa" loading="lazy"/>
                        </figure>
                    </a>
                    <div>
                        <p className="text-white text-base md:text-2xl font-light text-center">8422 NW 66 St Miami, 33166</p>
                    </div>
                </div>
            </div>
