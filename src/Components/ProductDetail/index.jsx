...
const ProductDetail = () => {
    ...
    return (
        ...
        items-center justify-center fixed z-50 rounded-lg`}>
                <div className="cursor-pointer rounded-lg absolute right-0 top-0 m-3 transition-transform transform-gpu hover:scale-110 hover:bg-red-600 ease-out duration-300"
