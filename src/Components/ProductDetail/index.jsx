...
const ProductDetail = () => {
    ...
    return (
        ...
        items-center fixed z-50 right-0 rounded-lg `}>
            <div className="div-detail flex justify-between items-center mt-3 mb-3">
            ...
            <div className="flex flex-col items-center justify-center">
                <div className="div-contain-img flex items-center justify-center w-70 h-60 mb-3">
                    <div className="cursor-pointer m-2" onClick={prevImage}>
                        ...
                        <div className="img-contain w-70 h-auto">
                ...
                <p className="font-light text-base px-6 mb-6">{context.productShow.description}</p>
            </div>
        </aside>
    )
}
