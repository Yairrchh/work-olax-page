...
const BodyHome = () => {
    ...
    return (
        <>
            ...
            <Reveal as="div" className="div-features-row flex items-center mt-8 md:mt-16 justify-center md:justify-between px-6 md:px-0">
            ...
            <Reveal as="div" className="div-olax-happy flex flex-col items-center justify-center rounded-2xl m-4 mt-6 md:mt-16 px-4 md:px-0">
